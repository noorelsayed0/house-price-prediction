This project demonstrates a simple regression model built using a Deep Neural Network (DNN) to predict house prices based on various property features such as:
